...
export default function HomeScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#FDECEF", padding: 16, gap: 14 }}>
      <View
        style={{
      ...
      >
        ...
        <View
          style={{
            ...
            height: 10,
            borderRadius: 999,
            backgroundColor: "#F3D3DC",
            overflow: "hidden",
          }}
        >
          <View
            style={{
              width: `${(today.cycleDay / 28) * 100}%`,
              height: "100%",
      ...
      >
        ...
        <Pressable
          ...
          style={{ paddingVertical: 12, borderRadius: 14, backgroundColor: "#FDECEF" }}
        >
          <Text style={{ color: "#333", paddingHorizontal: 12 }}>
            Continue Cycle Literacy
          </Text>
        </Pressable>
        <Pressable
